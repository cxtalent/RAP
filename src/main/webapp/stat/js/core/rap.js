...
(function() {
    ...
    var ws       = rap.workspace,       // workspace module
        ...
        TEMPLATE = {            // static template
            ...
            "REQUEST_BEGIN"                 : "<h2>请求参数列表</h2><table class=\"table-a\"><tr class=\"head\"><td class=\"head-expander\"></td><td class=\"head-identifier\">变量名</td><td class=\"head-name\">含义</td><td class=\"head-type\">类型</td><td class=\"head-length\">长度</td><td class=\"head-needed\">必需性</td><td class=\"head-remark\">备注</td></tr>",
            "REQUEST_BEGIN_EDIT"            : "<h2>请求参数列表</h2><table class=\"table-a\"><tr class=\"head\"><td class=\"head-expander\"></td><td class=\"head-op\">OP</td><td class=\"head-identifier\">变量名</td><td class=\"head-name\">含义</td><td class=\"head-type\">类型</td><td class=\"head-length\">长度</td><td class=\"head-needed\">必需性</td><td class=\"head-remark\">备注</td></tr>",
            "REQUEST_END"                   : "</table>",
            ...
            "RESPONSE_BEGIN"                : "<h2>响应参数列表</h2><table class=\"table-a\"><tr class=\"head\"><td class=\"head-expander\"></td><td class=\"head-identifier\">变量名</td><td class=\"head-name\">含义</td><td class=\"head-type\">类型</td><td class=\"head-length\">长度</td><td class=\"head-needed\">必需性</td><td class=\"head-remark\">备注</td></tr>",
            "RESPONSE_BEGIN_EDIT"           : "<h2>响应参数列表</h2><table class=\"table-a\"><tr class=\"head\"><td class=\"head-expander\"></td><td class=\"head-op\">OP</td><td class=\"head-identifier\">变量名</td><td class=\"head-name\">含义</td><td class=\"head-type\">类型</td><td class=\"head-length\">长度</td><td class=\"head-needed\">必需性</td><td class=\"head-remark\">备注</td></tr>",
            "RESPONSE_END"                  : "</table>",
